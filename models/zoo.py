...
class meta_net(nn.Module):
    def __init__(self, emb_d, out_d, n_tasks, r=16):
        super(meta_net, self).__init__()
        self.lin1 = LoRA_Linear(emb_d, emb_d // 16, r, n_tasks)
        self.relu = nn.ReLU(inplace=True)
        self.lin2 = LoRA_Linear(emb_d // 16, out_d, r, n_tasks)
...
class CoPrompt(nn.Module):
    def __init__(self, emb_d, n_tasks, prompt_param, key_dim=768):
        ...
        #     ("linear1", nn.Linear(emb_d, emb_d // 16)),
    ...
    def forward(self, x_querry, l, x_block, task_id, train=False):
        # e prompts
        e_valid = False
