...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        # # print(torch.mm(token_suffix.view(token_suffix.shape[0], -1), token_suffix.view(token_suffix.shape[0], -1).permute(1,0)))
        # self.token_suffix.data.copy_(token_suffix.data)
