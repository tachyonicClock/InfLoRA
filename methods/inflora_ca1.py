...
class InfLoRA_CA1(BaseLearner):
    def __init__(self, args):
        ...
        if args["dataset"] == "cifar100":
            del self._network.image_encoder.norm
            self._network.image_encoder.norm = nn.LayerNorm(768)
    ...
    def after_task(self):
        ...
        # self._network.classifier_recall()
    ...
    def incremental_train(self, data_manager):
        ...
        # self._network.classifier_backup()
